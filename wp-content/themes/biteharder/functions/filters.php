...
function spm_body_class($classes) {
	array_push( $classes, 'page-slug-'.get_post_field('post_name') );
	
	return $classes;
}
add_filter('body_class', 'spm_body_class');
...
function spm_excerpt_more($more) {
	global $post;
