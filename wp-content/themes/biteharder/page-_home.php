...
<div id="homevideo">
	<div class="wrap">
		<div class="video_container">
			<iframe src="https://www.youtube.com/embed/UO8J7HSVe8M?rel=0&showinfo=0" frameborder="0" allowfullscreen></iframe>
		</div>
	</div>
</div>
		...
		<div class="columns three">
			<div class="column product wow zoomIn">
				...
				<div class="description"><div class="layer_2">
					<h3 class="title">Carbide Runner And Stud Sharpening Tools</h3>
					
					<?php /*<div class="entry">
						<p>Get maximum control on all surfaces with a fresh edge every time.</p>
					</div>*/ ?>
					
					<p><a href="/product-category/sharpening-tools/" class="button">Learn More</a></p>
				</div></div>
			</div>
			
			<div class="column product wow zoomIn" data-wow-delay="200ms">
				<div class="post_thumbnail" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/calls_to_action-product-img-12.jpg);"></div>
				
				<div class="description"><div class="layer_2">
					<h3 class="title">Polytune&trade; Suspension Products</h3>
					
					<?php /*<div class="entry">
						<p> Increased traction means a better grip and a safer ride.</p>
					</div>*/ ?>
					
					<p><a href="/product/polyurethane-suspension-tuning-rings-snow/" class="button">Learn More</a></p>
				</div></div>
			</div>
